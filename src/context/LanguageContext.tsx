...
export const translations: Translations = {
  ...
  goalsTab: { tr: 'Hedefler', en: 'Goals', fa: 'اهداف' },
  ...
  currentStreak: { tr: 'Mevcut Seri', en: 'Current Streak', fa: 'سری فعلی' },
  bestWinStreak: { tr: 'En İyi Kazanç Serisi', en: 'Best Win Streak', fa: 'بهترین سری برد' },
  bestLossStreak: { tr: 'En Kötü Kayıp Serisi', en: 'Best Loss Streak', fa: 'بدترین سری باخت' },
  maxDrawdown: { tr: 'Max Drawdown', en: 'Max Drawdown', fa: 'حداکثر افت' },
  drawdownChart: { tr: 'Drawdown Grafiği', en: 'Drawdown Chart', fa: 'نمودار افت' },
  heatMap: { tr: 'Isı Haritası', en: 'Heat Map', fa: 'نقشه حرارتی' },
  setupPerformance: { tr: 'Setup Performansı', en: 'Setup Performance', fa: 'عملکرد ستاپ' },
  symbolPerformance: { tr: 'Sembol Performansı', en: 'Symbol Performance', fa: 'عملکرد نماد' },
  profitable: { tr: 'Karlı', en: 'Profitable', fa: 'سودآور' },
  losing: { tr: 'Zararlı', en: 'Losing', fa: 'زیان‌ده' },
  ...
  // Goals
  goalsTitle: { tr: 'Hedefler & Kurallar', en: 'Goals & Rules', fa: 'اهداف و قوانین' },
  editGoals: { tr: 'Hedefleri Düzenle', en: 'Edit Goals', fa: 'ویرایش اهداف' },
  monthlyPnLGoal: { tr: 'Aylık PnL Hedefi', en: 'Monthly PnL Goal', fa: 'هدف سود ماهانه' },
  winRateGoal: { tr: 'Win Rate Hedefi', en: 'Win Rate Goal', fa: 'هدف نرخ برد' },
  maxDailyTrades: { tr: 'Günlük Max İşlem', en: 'Max Daily Trades', fa: 'حداکثر معاملات روزانه' },
  maxRiskPerTrade: { tr: 'İşlem Başı Max Risk', en: 'Max Risk Per Trade', fa: 'حداکثر ریسک هر معامله' },
  maxRiskDesc: { tr: 'Bu limitin üzerinde risk alan işlemler ihlal olarak işaretlenir.', en: 'Trades exceeding this limit will be flagged as violations.', fa: 'معاملات بیش از این حد به عنوان نقض علامت‌گذاری می‌شوند.' },
  noTradeHours: { tr: 'İşlem Yasak Saatler', en: 'No-Trade Hours', fa: 'ساعات ممنوع معامله' },
  noTradeHoursStart: { tr: 'Yasak Başlangıç Saati', en: 'No-Trade Start', fa: 'شروع ساعت ممنوع' },
  noTradeHoursEnd: { tr: 'Yasak Bitiş Saati', en: 'No-Trade End', fa: 'پایان ساعت ممنوع' },
  noTradeHoursDesc: { tr: 'Bu saatler arasında açılan işlemler ihlal olarak işaretlenir.', en: 'Trades opened during these hours will be flagged as violations.', fa: 'معاملات باز شده در این ساعات به عنوان نقض علامت‌گذاری می‌شوند.' },
  notSet: { tr: 'Belirlenmedi', en: 'Not set', fa: 'تنظیم نشده' },
  violations: { tr: 'Kural İhlalleri', en: 'Rule Violations', fa: 'نقض قوانین' },
  noViolations: { tr: 'Tüm kurallara uyuluyor! 🎉', en: 'All rules followed! 🎉', fa: 'همه قوانین رعایت شده! 🎉' },
  noGoalsTitle: { tr: 'Henüz hedef belirlenmedi', en: 'No goals set yet', fa: 'هنوز هدفی تعیین نشده' },
  noGoalsDesc: { tr: 'Aylık hedefler ve kurallar belirleyerek disiplininizi artırın.', en: 'Set monthly goals and rules to improve your discipline.', fa: 'اهداف ماهانه و قوانین تعیین کنید تا انضباط خود را بهبود بخشید.' },
  noMonthlyPnLGoal: { tr: 'Aylık PnL hedefi yok', en: 'No monthly PnL goal', fa: 'هدف سود ماهانه وجود ندارد' },
  noWinRateGoal: { tr: 'Win rate hedefi yok', en: 'No win rate goal', fa: 'هدف نرخ برد وجود ندارد' },
  noMaxDailyTrades: { tr: 'Günlük limit yok', en: 'No daily limit', fa: 'محدودیت روزانه وجود ندارد' },
  noMaxRisk: { tr: 'Risk limiti yok', en: 'No risk limit', fa: 'محدودیت ریسک وجود ندارد' },
  maxDailyTradesViolation: { tr: 'Günlük işlem limiti aşıldı', en: 'Daily trade limit exceeded', fa: 'محدودیت معاملات روزانه تجاوز شد' },
  maxRiskViolation: { tr: 'Risk limiti aşılan işlemler var', en: 'Trades exceeding risk limit', fa: 'معاملاتی که از حد ریسک تجاوز کرده‌اند' },
  noTradeHoursViolation: { tr: 'Yasak saatlerde işlem yapıldı', en: 'Trades during no-trade hours', fa: 'معاملات در ساعات ممنوع' },
};
