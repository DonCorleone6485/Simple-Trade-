...
export const translations: Translations = {
  ...
  checklistsTab: { tr: 'Checklist', en: 'Checklists', fa: 'چک‌لیست‌ها', ar: 'قوائم التحقق', ru: 'Чек-листы', es: 'Checklists', pt: 'Checklists', de: 'Checklisten', fr: 'Checklists' },
  propReviewTitle: { tr: 'Prop Hesabı Değerlendirme', en: 'Prop Account Review', fa: 'ارزیابی حساب پراپ', ar: 'تقييم حساب التمويل', ru: 'Оценка проп-счёта', es: 'Evaluación de cuenta prop', pt: 'Avaliação de conta prop', de: 'Prop-Konto-Bewertung', fr: 'Évaluation de compte prop' },
  propReviewIntro: { tr: 'Bir prop hesabını 12 maddede puanla, 100 üzerinden ne ettiğini gör. Üçe kadar firmayı yan yana koyup karşılaştırabilirsin. Her maddenin yanındaki "Açıklama ve örnek" o kuralın ne anlama geldiğini rakamlarla anlatır.', en: 'Score a prop account on 12 criteria and see what it makes out of 100. Compare up to three firms side by side. "Explanation and example" next to each criterion spells out what the rule means, in numbers.', fa: 'یک حساب پراپ را در ۱۲ بند امتیاز بده و ببین از ۱۰۰ چند می‌شود. تا سه شرکت را کنار هم مقایسه کن. «توضیح و مثال» کنار هر بند معنای آن قانون را با عدد شرح می‌دهد.', ar: 'قيّم حساب تمويل عبر 12 بنداً وشاهد نتيجته من 100. يمكنك مقارنة حتى ثلاث شركات جنباً إلى جنب. «شرح ومثال» بجانب كل بند يوضح معنى القاعدة بالأرقام.', ru: 'Оцените проп-счёт по 12 критериям и посмотрите результат из 100. Можно сравнить до трёх фирм рядом. «Пояснение и пример» рядом с каждым пунктом объясняет правило в цифрах.', es: 'Puntúa una cuenta prop en 12 criterios y mira cuánto saca sobre 100. Puedes comparar hasta tres firmas en paralelo. "Explicación y ejemplo" junto a cada criterio explica la regla con números.', pt: 'Pontue uma conta prop em 12 critérios e veja quanto faz em 100. Dá para comparar até três firmas lado a lado. "Explicação e exemplo" ao lado de cada critério explica a regra com números.', de: 'Bewerte ein Prop-Konto in 12 Punkten und sieh, was es von 100 erreicht. Du kannst bis zu drei Firmen nebeneinander vergleichen. "Erklärung und Beispiel" neben jedem Punkt erklärt die Regel in Zahlen.', fr: 'Notez un compte prop sur 12 critères et voyez ce qu\'il obtient sur 100. Vous pouvez comparer jusqu\'à trois firmes côte à côte. « Explication et exemple » à côté de chaque critère explique la règle en chiffres.' },
  propFirm: { tr: 'Firma', en: 'Firm', fa: 'شرکت', ar: 'شركة', ru: 'Фирма', es: 'Firma', pt: 'Firma', de: 'Firma', fr: 'Firme' },
  propFirmName: { tr: 'Firma adı', en: 'Firm name', fa: 'نام شرکت', ar: 'اسم الشركة', ru: 'Название фирмы', es: 'Nombre de la firma', pt: 'Nome da firma', de: 'Firmenname', fr: 'Nom de la firme' },
  propCompare: { tr: 'Karşılaştır', en: 'Compare', fa: 'مقایسه', ar: 'قارن', ru: 'Сравнить', es: 'Comparar', pt: 'Comparar', de: 'Vergleichen', fr: 'Comparer' },
  propOneMore: { tr: 'Bir firma daha', en: 'One more firm', fa: 'یک شرکت دیگر', ar: 'شركة أخرى', ru: 'Ещё одна фирма', es: 'Una firma más', pt: 'Mais uma firma', de: 'Noch eine Firma', fr: 'Une firme de plus' },
  propRemove: { tr: 'Kaldır', en: 'Remove', fa: 'حذف', ar: 'إزالة', ru: 'Убрать', es: 'Quitar', pt: 'Remover', de: 'Entfernen', fr: 'Retirer' },
  propExplain: { tr: 'Açıklama ve örnek', en: 'Explanation and example', fa: 'توضیح و مثال', ar: 'شرح ومثال', ru: 'Пояснение и пример', es: 'Explicación y ejemplo', pt: 'Explicação e exemplo', de: 'Erklärung und Beispiel', fr: 'Explication et exemple' },
  propInRulebook: { tr: 'Kurallarda şöyle geçer:', en: 'In the rulebook:', fa: 'در قوانین چنین می‌آید:', ar: 'في نص القواعد:', ru: 'В правилах это звучит так:', es: 'En el reglamento aparece así:', pt: 'No regulamento aparece assim:', de: 'Im Regelwerk heißt es:', fr: 'Dans le règlement :' },
  propPoints: { tr: 'puan', en: 'points', fa: 'امتیاز', ar: 'نقطة', ru: 'баллов', es: 'puntos', pt: 'pontos', de: 'Punkte', fr: 'points' },
  propResult: { tr: 'Sonuç', en: 'Result', fa: 'نتیجه', ar: 'النتيجة', ru: 'Результат', es: 'Resultado', pt: 'Resultado', de: 'Ergebnis', fr: 'Résultat' },
  propClear: { tr: 'Sıfırla', en: 'Clear', fa: 'پاک کردن', ar: 'تصفير', ru: 'Сбросить', es: 'Limpiar', pt: 'Limpar', de: 'Zurücksetzen', fr: 'Réinitialiser' },
  propClearConfirm: { tr: 'Bütün cevaplar silinsin mi?', en: 'Clear every answer?', fa: 'همهٔ پاسخ‌ها پاک شود؟', ar: 'هل تُمسح كل الإجابات؟', ru: 'Удалить все ответы?', es: '¿Borrar todas las respuestas?', pt: 'Apagar todas as respostas?', de: 'Alle Antworten löschen?', fr: 'Effacer toutes les réponses ?' },
  propNotSuitable: { tr: 'UYGUN DEĞİL', en: 'NOT SUITABLE', fa: 'مناسب نیست', ar: 'غير مناسب', ru: 'НЕ ПОДХОДИТ', es: 'NO APTA', pt: 'NÃO SERVE', de: 'NICHT GEEIGNET', fr: 'NE CONVIENT PAS' },
  propYourRedLine: { tr: 'Kırmızı çizgin:', en: 'Your red line:', fa: 'خط قرمز شما:', ar: 'خطك الأحمر:', ru: 'Ваша красная линия:', es: 'Tu línea roja:', pt: 'A tua linha vermelha:', de: 'Deine rote Linie:', fr: 'Votre ligne rouge :' },
  propRedLineTitle: { tr: 'Bu bende olamaz — kırmızı çizgi', en: 'A deal-breaker for me', fa: 'این برای من قابل قبول نیست', ar: 'هذا مرفوض بالنسبة لي', ru: 'Для меня это неприемлемо', es: 'Para mí es inaceptable', pt: 'Para mim é inaceitável', de: 'Für mich ein Ausschlusskriterium', fr: 'Rédhibitoire pour moi' },
  propAnswered: { tr: 'madde dolduruldu', en: 'criteria answered', fa: 'بند تکمیل شد', ar: 'بنداً تمت الإجابة عنها', ru: 'пунктов заполнено', es: 'criterios respondidos', pt: 'critérios respondidos', de: 'Punkte beantwortet', fr: 'critères remplis' },
  propLeads: { tr: 'önde', en: 'leads', fa: 'جلوتر است', ar: 'في المقدمة', ru: 'впереди', es: 'va por delante', pt: 'está à frente', de: 'führt', fr: 'en tête' },
  propGapFrom: { tr: 'Fark en çok şu maddelerden geliyor:', en: 'The gap comes mostly from:', fa: 'بیشترین تفاوت از این بندها می‌آید:', ar: 'الفارق يأتي أساساً من:', ru: 'Разрыв в основном из-за:', es: 'La diferencia viene sobre todo de:', pt: 'A diferença vem sobretudo de:', de: 'Der Abstand kommt vor allem von:', fr: 'L\'écart vient surtout de :' },
  propCriterion: { tr: 'Madde', en: 'Criterion', fa: 'بند', ar: 'البند', ru: 'Критерий', es: 'Criterio', pt: 'Critério', de: 'Punkt', fr: 'Critère' },
  propTotal: { tr: 'Toplam', en: 'Total', fa: 'مجموع', ar: 'المجموع', ru: 'Итого', es: 'Total', pt: 'Total', de: 'Gesamt', fr: 'Total' },
  propRedLineShort: { tr: 'kırmızı çizgi', en: 'red line', fa: 'خط قرمز', ar: 'خط أحمر', ru: 'красная линия', es: 'línea roja', pt: 'linha vermelha', de: 'rote Linie', fr: 'ligne rouge' },
  propFloorNote: { tr: 'Her maddede en kötü seçenek işaretlenseydi {n} puan çıkardı — yani taban sıfır değil. Puan tek başına da yeterli değil: yüksek puanlı bir hesap, tek bir kural yüzünden senin tarzına uymayabilir. Kabul edemeyeceğin seçenekleri yasak işaretiyle kırmızı çizgi yap; o seçenek işaretli bir firma, puanı 90 bile olsa "uygun değil" görünür.', en: 'Picking the worst option everywhere would still score {n} — the floor is not zero. And the score alone is not enough: a high-scoring account can still be wrong for you because of one rule. Mark the options you cannot live with as red lines; a firm with that option shows as "not suitable" even at 90 points.', fa: 'اگر در هر بند بدترین گزینه انتخاب می‌شد باز {n} امتیاز می‌شد — یعنی کف صفر نیست. امتیاز به‌تنهایی کافی نیست: حسابی با امتیاز بالا ممکن است به خاطر یک قانون به سبک تو نخورد. گزینه‌هایی را که نمی‌پذیری خط قرمز کن؛ شرکتی با آن گزینه حتی با امتیاز ۹۰ «مناسب نیست» نشان داده می‌شود.', ar: 'لو اختير أسوأ خيار في كل بند لبقيت النتيجة {n} — أي أن القاع ليس صفراً. والنتيجة وحدها لا تكفي: حساب بنتيجة عالية قد لا يناسب أسلوبك بسبب قاعدة واحدة. اجعل الخيارات التي لا تقبلها خطوطاً حمراء؛ الشركة التي تحمل ذلك الخيار تظهر «غير مناسبة» ولو بلغت 90 نقطة.', ru: 'Если везде выбрать худший вариант, всё равно получится {n} баллов — то есть дно не ноль. И одного балла мало: счёт с высоким баллом может не подойти вам из-за одного правила. Отметьте неприемлемые варианты как красные линии; фирма с таким вариантом будет показана как «не подходит» даже при 90 баллах.', es: 'Marcando la peor opción en todo saldrían {n} puntos: el suelo no es cero. Y la puntuación sola no basta: una cuenta con nota alta puede no encajarte por una sola regla. Marca como línea roja las opciones que no aceptas; una firma con esa opción aparece como "no apta" aunque saque 90.', pt: 'Marcando a pior opção em tudo ainda daria {n} pontos: o piso não é zero. E a pontuação sozinha não basta: uma conta com nota alta pode não servir para ti por causa de uma única regra. Marca como linha vermelha as opções que não aceitas; uma firma com essa opção aparece como "não serve" mesmo com 90.', de: 'Überall die schlechteste Option ergäbe immer noch {n} Punkte — der Boden ist also nicht null. Und die Punktzahl allein reicht nicht: ein hoch bewertetes Konto kann wegen einer einzigen Regel trotzdem nicht zu dir passen. Markiere Optionen, die für dich nicht infrage kommen, als rote Linie; eine Firma mit dieser Option gilt auch bei 90 Punkten als "nicht geeignet".', fr: 'Cocher partout la pire option donnerait encore {n} points : le plancher n\'est pas zéro. Et la note seule ne suffit pas : un compte bien noté peut ne pas vous convenir à cause d\'une seule règle. Marquez en ligne rouge les options que vous refusez ; une firme qui la porte apparaît « ne convient pas » même à 90 points.' },
  propPrintNote: { tr: 'Toplam 100 puan üzerindendir; her maddede en kötü seçenek {n} puan bırakır. Puan bandları: 85+ kusursuza yakın, 70–84 güçlü, 55–69 ortalama, 40–54 zayıf, 40 altı kötü.', en: 'The total is out of 100; the worst option everywhere still leaves {n}. Bands: 85+ near flawless, 70–84 strong, 55–69 average, 40–54 weak, below 40 poor.', fa: 'مجموع از ۱۰۰ است؛ بدترین گزینه در همه بندها {n} امتیاز باقی می‌گذارد. بازه‌ها: ۸۵+ تقریباً بی‌نقص، ۷۰–۸۴ قوی، ۵۵–۶۹ متوسط، ۴۰–۵۴ ضعیف، زیر ۴۰ بد.', ar: 'المجموع من 100؛ وأسوأ خيار في كل بند يترك {n}. الشرائح: 85+ شبه مثالي، 70–84 قوي، 55–69 متوسط، 40–54 ضعيف، دون 40 سيئ.', ru: 'Итог из 100; худший вариант везде оставляет {n}. Диапазоны: 85+ почти безупречно, 70–84 сильно, 55–69 средне, 40–54 слабо, ниже 40 плохо.', es: 'El total es sobre 100; la peor opción en todo deja {n}. Bandas: 85+ casi impecable, 70–84 sólida, 55–69 media, 40–54 débil, menos de 40 mala.', pt: 'O total é sobre 100; a pior opção em tudo deixa {n}. Faixas: 85+ quase impecável, 70–84 forte, 55–69 média, 40–54 fraca, abaixo de 40 ruim.', de: 'Die Summe geht bis 100; die schlechteste Option überall lässt {n}. Bänder: 85+ nahezu makellos, 70–84 stark, 55–69 Durchschnitt, 40–54 schwach, unter 40 schlecht.', fr: 'Le total est sur 100 ; la pire option partout laisse {n}. Tranches : 85+ presque parfait, 70–84 solide, 55–69 moyen, 40–54 faible, moins de 40 mauvais.' },
  propReviewTab: { tr: 'Prop Değerlendirme', en: 'Prop Review', fa: 'ارزیابی پراپ', ar: 'تقييم شركات التمويل', ru: 'Оценка проп-фирм', es: 'Evaluación Prop', pt: 'Avaliação Prop', de: 'Prop-Bewertung', fr: 'Évaluation Prop' },
  ...
  emotion: { tr: 'Duygu Durumu', en: 'State of Mind', fa: 'حال روحی', ar: 'الحالة النفسية', ru: 'Эмоциональное состояние', es: 'Estado de ánimo', pt: 'Estado emocional', de: 'Gemütszustand', fr: 'État d\'esprit' },
  entryPrice: { tr: 'Giriş Fiyatı', en: 'Entry Price', fa: 'قیمت ورود', ar: 'سعر الدخول', ru: 'Цена входа', es: 'Precio de entrada', pt: 'Preço de entrada', de: 'Einstiegskurs', fr: 'Prix d\'entrée' },
  stopLossPrice: { tr: 'Stop Loss', en: 'Stop Loss', fa: 'حد ضرر', ar: 'وقف الخسارة', ru: 'Стоп-лосс', es: 'Stop Loss', pt: 'Stop Loss', de: 'Stop-Loss', fr: 'Stop Loss' },
  exitPrice: { tr: 'Çıkış Fiyatı', en: 'Exit Price', fa: 'قیمت خروج', ar: 'سعر الخروج', ru: 'Цена выхода', es: 'Precio de salida', pt: 'Preço de saída', de: 'Ausstiegskurs', fr: 'Prix de sortie' },
  ...
  requiredHint: { tr: 'işleme girerken belli olan tek şey parite ve yön; gerisini sonra tamamlayabilirsin', en: 'the only things you know when you enter are the symbol and the direction — fill in the rest later', fa: 'هنگام ورود فقط نماد و جهت مشخص است؛ بقیه را بعداً تکمیل کنید', ar: 'عند الدخول لا تعرف سوى الرمز والاتجاه — أكمل الباقي لاحقاً', ru: 'при входе известны только инструмент и направление — остальное заполните позже', es: 'al entrar solo sabes el símbolo y la dirección — completa el resto después', pt: 'ao entrar só sabes o símbolo e a direção — completa o resto depois', de: 'beim Einstieg stehen nur Symbol und Richtung fest — den Rest später ergänzen', fr: 'à l\'entrée, seuls le symbole et le sens sont connus — complétez le reste plus tard' },
